...
class FilmPopup extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(film) {
    super();
    this._film = film;
  }
...
class FilmsContainer extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
class MainNav extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(filters) {
    super();
...
const getSortedFilms = (films, sortType, from, to) => {
  ...
  switch (sortType) {
    case _components_sort__WEBPACK_IMPORTED_MODULE_8__["SortType"].DATE:
      sortedFilms.sort((a, b) => b.releaseDate - a.releaseDate);
      break;
    case _components_sort__WEBPACK_IMPORTED_MODULE_8__["SortType"].RATING:
      sortedFilms.sort((a, b) => b.rating - a.rating);
      break;
    case _components_sort__WEBPACK_IMPORTED_MODULE_8__["SortType"].DEFAULT:
      break;
  }
...
class PageController {
  ...
  render(films) {
    ...
    Object(_utils_dom__WEBPACK_IMPORTED_MODULE_10__["render"])(this._filmsContainerComponent.getElement(), this._filmsListComponent);

    if (films.length === 0) {
      Object(_utils_dom__WEBPACK_IMPORTED_MODULE_10__["render"])(this._filmsListComponent.getElement(), this._noFilmsComponent);
      return;
    }
