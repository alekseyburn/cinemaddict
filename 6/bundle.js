...
class FilmPopup {
  ...
  getElement() {
    if (!this._element) {
      this._element = Object(_utils_dom__WEBPACK_IMPORTED_MODULE_1__["createElement"])(this.getTemplate());
    }
    return this._element;
  }
...
/* harmony import */ var _components_profile__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/profile */ "./src/components/profile.js");
...
/* harmony import */ var _mocks_films__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./mocks/films */ "./src/mocks/films.js");
/* harmony import */ var _mocks_filters__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./mocks/filters */ "./src/mocks/filters.js");
/* harmony import */ var _utils_random__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./utils/random */ "./src/utils/random.js");
...
const renderFilmCard = (filmContainer, film) => {
  const showPopupHandler = () => {
    Object(_utils_dom__WEBPACK_IMPORTED_MODULE_13__["render"])(document.body, filmPopupElement);
  ...
  const filmCardElement = new _components_film_card__WEBPACK_IMPORTED_MODULE_0__["default"](film).getElement();
  ...
  const filmPopupElement = new _components_film_popup__WEBPACK_IMPORTED_MODULE_1__["default"](film).getElement();
  ...
  Object(_utils_dom__WEBPACK_IMPORTED_MODULE_13__["render"])(filmContainer, filmCardElement);
};

const renderFilmsContainer = (filmsComponent, films) => {
  const filmsList = new _components_films_list__WEBPACK_IMPORTED_MODULE_3__["default"]().getElement();
  Object(_utils_dom__WEBPACK_IMPORTED_MODULE_13__["render"])(filmsMain, filmsList);

  if (films.length === 0) {
    Object(_utils_dom__WEBPACK_IMPORTED_MODULE_13__["render"])(filmsList, new _components_no_films__WEBPACK_IMPORTED_MODULE_7__["default"]().getElement());
    return;
  }

  Object(_utils_dom__WEBPACK_IMPORTED_MODULE_13__["render"])(filmsMain, new _components_films_list_extra__WEBPACK_IMPORTED_MODULE_4__["default"](`Top rated`).getElement());
  Object(_utils_dom__WEBPACK_IMPORTED_MODULE_13__["render"])(filmsMain, new _components_films_list_extra__WEBPACK_IMPORTED_MODULE_4__["default"](`Most commented`).getElement());

  const loadMoreButton = new _components_load_more__WEBPACK_IMPORTED_MODULE_5__["default"]().getElement();
  Object(_utils_dom__WEBPACK_IMPORTED_MODULE_13__["render"])(filmsList, loadMoreButton);
...
Object(_utils_dom__WEBPACK_IMPORTED_MODULE_13__["render"])(header, new _components_profile__WEBPACK_IMPORTED_MODULE_8__["default"]().getElement());
const main = document.querySelector(`.main`);
Object(_utils_dom__WEBPACK_IMPORTED_MODULE_13__["render"])(main, new _components_main_nav__WEBPACK_IMPORTED_MODULE_6__["default"](_mocks_filters__WEBPACK_IMPORTED_MODULE_11__["filters"]).getElement());
Object(_utils_dom__WEBPACK_IMPORTED_MODULE_13__["render"])(main, new _components_sort__WEBPACK_IMPORTED_MODULE_9__["default"]().getElement());
const filmsMain = new _components_films_main__WEBPACK_IMPORTED_MODULE_2__["default"]().getElement();
Object(_utils_dom__WEBPACK_IMPORTED_MODULE_13__["render"])(main, filmsMain);

const films = Object(_utils_random__WEBPACK_IMPORTED_MODULE_12__["generateArray"])(_mocks_films__WEBPACK_IMPORTED_MODULE_10__["generateFilm"], CARDS_COUNT);
...
const render = (parent, element, plasce = `beforeend`) =>
